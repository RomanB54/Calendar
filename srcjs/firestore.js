...
class FireStore {
  ...
  filter(filterOptionKey, filterOptionValue) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const queryRef = (0, firestore_1.collection)(db, this.storeID);
        const q = (0, firestore_1.query)(
          queryRef,
          (0, firestore_1.where)(filterOptionKey, '==', filterOptionValue),
        );
        ...
        const filteredArray = querySnapshot.docs.map((doc) => {
          const data = doc.data();
          return data;
        });
  ...
  getOneTask(taskIdForSearch) {
    return __awaiter(this, void 0, void 0, function* () {
      const docRef = (0, firestore_1.doc)(db, this.storeID, taskIdForSearch);
