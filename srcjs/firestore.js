...
class FireStore {
    ...
    read() {
        return __awaiter(this, void 0, void 0, function* () {
            const tempData = yield (0, firestore_1.getDocs)((0, firestore_1.collection)(db, this.storeID));
    ...
    update(task) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, firestore_1.setDoc)(taskTemp, Object.assign({}, task), { merge: true });
        });
    }
    delete(task) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    filter(filterOptionKey, filterOptionValue) {
        return __awaiter(this, void 0, void 0, function* () {
            const filteredTasks = [];
            const snapshot = yield (0, firestore_1.getDocs)((0, firestore_1.collection)(db, this.storeID));
