...
test('create() calls setDoc with correct arguments', () => __awaiter(void 0, void 0, void 0, function* () {
    const mockTask = {
        taskId: 'task1',
        name: 'new task1',
        date: '2024-12-22 23:23:23',
...
test('filter() returns tasks matching criteria', () => __awaiter(void 0, void 0, void 0, function* () {
    const mockData = [
        {
            id: 'task1',
            data: () => ({
...
test('delete() removes document by ID', () => __awaiter(void 0, void 0, void 0, function* () {
    const mockTask = {
        taskId: 'task2',
        name: 'new task2',
        date: '2024-12-23 22:22:22',
...
test('update() calls setDoc with correct arguments', () => __awaiter(void 0, void 0, void 0, function* () {
    const mockTask = {
        taskId: 'task1',
        name: 'new task1',
        date: '2024-12-22 23:23:23',
